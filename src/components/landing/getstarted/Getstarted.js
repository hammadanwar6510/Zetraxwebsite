                ...
                <div className="custum-container">
                    <div className="cntgetstarted">
                        ...
                        <div className="buttonsgetstarted">
                            ...
                            <button className='buttontwogetstarted'> <a className='scroll-text' href="">Join Community</a> </button>
                            <button className='buttontwogetstarted buttonthreegetstarted'> <a className='scroll-text'  href="#">Docs</a></button>
                        </div>
                    </div>
                </div>
            </div>
